...
const MOCK_PROFILES: Profile[] = [
  { id: '2', name: 'Sarah Chen', role: 'Product Designer', interests: ['Design', 'AI', 'Startups'], lookingFor: 'Looking for a technical co-founder for my AI design tool startup' },
  { id: '3', name: 'Marcus Johnson', role: 'Full Stack Developer', interests: ['AI', 'Startups', 'Web3'], lookingFor: 'Seeking mentorship from experienced founders and potential collaborators' },
  { id: '4', name: 'Emily Rodriguez', role: 'Marketing Manager', interests: ['Growth', 'Startups', 'Content'], lookingFor: 'Networking with startup founders who need growth marketing help' },
  { id: '5', name: 'David Kim', role: 'Data Scientist', interests: ['AI', 'Data', 'ML'], lookingFor: 'Exploring job opportunities at early-stage AI companies' },
  { id: '6', name: 'Lisa Wang', role: 'UX Researcher', interests: ['Design', 'Psychology', 'Research'], lookingFor: 'Partnership opportunities for user research projects' },
  { id: '7', name: 'Tom Bradley', role: 'Startup Founder', interests: ['Startups', 'Sales', 'Growth'], lookingFor: 'Raising a seed round and connecting with potential investors' },
  { id: '8', name: 'Nina Patel', role: 'Software Engineer', interests: ['AI', 'Open Source', 'Developer Tools'], lookingFor: 'Interested in contributing to open source AI projects and finding collaborators' },
];
