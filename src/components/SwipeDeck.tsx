        ...
        <div className="relative h-[500px]">
          ...
          >
            ...
            <div className="h-full flex flex-col">
              {/* Avatar Section - Transparent Glass Effect */}
              <div className="h-64 flex items-center justify-center relative overflow-hidden bg-gradient-to-br from-purple-500/20 via-violet-500/20 to-indigo-500/20 backdrop-blur-sm border-b border-purple-400/20">
                {currentMatch.profileImage ? (
                  ...
                  <div className="w-32 h-32 rounded-full bg-gradient-to-br from-purple-600 via-violet-600 to-indigo-600 flex items-center justify-center border-2 border-purple-400/30">
                    <span className="text-white text-4xl">{currentMatch.name.charAt(0)}</span>
                  </div>
                )}
              </div>
